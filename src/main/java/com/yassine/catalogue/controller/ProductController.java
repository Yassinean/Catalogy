...
public class ProductController {
    ...
    public ResponseEntity<ProductResponseDto> update(
        ...
        ProductResponseDto updateProductResponseDto = productInterface.update(id,productRequestDto);
    ...
    public ResponseEntity<ProductResponseDto> findById(@PathVariable Long id){
        return productInterface.findById(id).map(ResponseEntity::ok).orElse(ResponseEntity.notFound().build());
    }
